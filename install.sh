...
LOCAL_MANAGER="${SCRIPT_DIR}/scripts/autodagger-manager.sh"
...
MANAGER_URL="https://raw.githubusercontent.com/${REPO_OWNER}/${REPO_NAME}/${BRANCH}/scripts/autodagger-manager.sh"

TMP_SCRIPT="$(mktemp /tmp/autodagger-manager.XXXXXX.sh)"
